...
public class PostController {
    ...
    @GetMapping("/of/{id}")
    public ResponseEntity<List<PostResponse>> getPostByClassroomId(@PathVariable Long id) {
        return new ResponseEntity<>(postService.getPostByClassroomId(id), HttpStatus.OK);
    }
